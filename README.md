...
<p align='center'>
  <img src='./public/typograph-og.jpg' alt='skoomaDen' width='600'/>
</p>

<h6 align='center'>
<a href="https://astro-theme-skoomaDen.vercel.app/">Live Demo</a>
</h6>
<h5 align='center'>
<b>This work is rewrite from <a href="https://github.com/sumimakito/hexo-theme-skoomaDen">hexo-theme-skoomaDen</a></b>
</h5>
<p align='center'>
...
- **Fast**. 100% [Pagespeed Score](https://pagespeed.web.dev/analysis/https-astro-theme-skoomaDen-vercel-app/j34nq9tx0s?form_factor=desktop).
- **skoomaDen** Derived from prevalent Chinese typographic norms and aims to provide an enhanced reading experience for website visitors.
...
- [Live Demo](https://astro-theme-skoomaDen.vercel.app/)
- [My Blog](https://blog.moeyua.com/)

## Getting Started

skoomaDen is a minimal, responsive and SEO-friendly Astro blog theme. This guide will help you get started with a new project. 
...
skoomaDen is highly customizable. The config file is in [src/theme.config.ts](src/theme.config.ts)

### Social links

skoomaDen has built-in support for adding links to your social media accounts to the site via the social option in the config file:

```ts
socials: [
  {
    name: "github",
    href: "https://github.com/moeyua/astro-theme-skoomaDen"
  }
  ...
]
```
...
skoomaDen supports dark mode. You can change it in the config file:
...
skoomaDen provides built-in support for multilingual sites. By default, the language is `en-us`, you can change it in the config file:
...
For now, skoomaDen supports below languages:
...
skoomaDen supports multiple comment services, currently supports [Disqus](https://disqus.com/), [Giscus](https://giscus.app/) and [Twikoo](https://twikoo.js.org/).
...
[![Pagespeed Score](https://github.com/moeyua/astro-theme-skoomaDen/assets/45156493/2272f576-d6ff-49ef-a294-5c2acf365907)](https://pagespeed.web.dev/analysis/https-astro-theme-skoomaDen-vercel-app/j34nq9tx0s?form_factor=desktop)
